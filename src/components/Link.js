    ...
    <div className="link-container">
      ...
      <div className="chat-section">
        <img
          ...
          height="35"
          alt="Chat Icon"
          src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/store-chat-earth-day-specialist-icon-202504_AV2?wid=70&hei=70&fmt=jpeg&qlt=90&.v=1742997161934"
        />
        <h3>Need shopping help?</h3>
        <button
          onClick={() => console.log('Ask a Specialist clicked')}
